...
database_connector_functions = [
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "database": {
                        "type": "string",
                        "description": "Use when you want to constrain the search to a specific database, this is highly recommended if you or the user knows the name of the database to focus on. But don't just use your workspace database by default unless the user agrees as you may miss out on data in other places.",
                    },
                    "schema": {
                        "type": "string",
                        "description": "Use to constrain the search to a specific schema. Use together with DATABASE. This is highly recommended if you or the user knows the name of the database and schema to focus on.   But don't just use your workspace schema by default unless the user agrees as you may miss out on data in other places.",
                    },
                },
                "required": ["query"],
            },
    ...
    #     "function": {
    #         "name": "_run_query",
    #         "description": "Run a query against a Snowflake database.  If you need to find tables to query, use search_metadata first to determine the right object names to query.  You need to specify either a SQL query OR a note_id.",
    #         "parameters": {
    #             "type": "object",
    #             "properties": {
    #                 "query": {
...
# The database tools have been moved to the database_tools.py file uing new style tools
# database_tools = {
