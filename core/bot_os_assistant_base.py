...
def execute_function(
    ...
    if function is not None:
        ...
        if func_name.startswith("_"):  # run internal BotOS functions in-process
            ...
            if func_name in {'_run_query', '_query_database', '_run_snowpark_python', '_send_email', '_manage_artifact', '_manage_tests', '_set_harvest_control_data', '_get_harvest_control_data', '_list_database_connections'}:
                s_arguments["bot_id"] = bot_id
