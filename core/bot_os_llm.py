...
class LLMKeyHandler:
    ...
    def get_llm_key_from_env(self):
        ...
        if self.default_llm_engine.lower() == "openai":
            ...
            if openai_llm_api_key and self.default_llm_engine.lower() == 'openai':
            ...
            openai_llm_api_key = os.getenv("REKA_API_KEY", None)
        elif self.default_llm_engine.lower() == "gemini":
            openai_llm_api_key = os.getenv("GEMINI_API_KEY", None)
        if self.default_llm_engine.lower() == "cortex" or self.default_llm_engine is None or llm_api_key is None:
            self.set_cortex_mode(True)
