...
from core.bot_os_defaults import EVE_MOTHER_OF_BOTS_INSTRUCTIONS, EVE_VALIDATION_INSTRUCTIONS
...
from generated_modules.webpage_downloader import webpage_tools, TOOL_FUNCTION_DESCRIPTION_WEBPAGE_DOWNLOADER
from generated_modules.vision_chat_analysis import vision_chat_analysis_action_function_mapping, TOOL_FUNCTION_DESCRIPTION_VISION_CHAT_ANALYSIS
import logging
...
session = BotOsSession("Eve 1000", instructions=EVE_MOTHER_OF_BOTS_INSTRUCTIONS, 
                       ...
                       tools=slack_tools + integration_tool_descriptions + [TOOL_FUNCTION_DESCRIPTION_WEBPAGE_DOWNLOADER, TOOL_FUNCTION_DESCRIPTION_VISION_CHAT_ANALYSIS],
                       available_functions=bind_slack_available_functions(slack_adapter) | integration_tools | webpage_tools | vision_chat_analysis_action_function_mapping,
                       bot_id = os.getenv('BOT_ID',default="local-test-default-bot"),
                       bot_name = os.getenv('BOT_NAME',default="local-test-default-bot-name"),
                    )
session.add_task("Check in with your manager to see if they have tasks for you to work on.",
