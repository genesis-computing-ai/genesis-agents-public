...
from core.bot_os_defaults import EVE_MOTHER_OF_BOTS_INSTRUCTIONS, EVE_VALIDATION_INSTRUCTIONS, ESTER_MANAGER_OF_BOTS_INSTRUCTIONS
...
for bot_config in bots_config:
    slack_adapter = SlackBotAdapter(token=bot_config["slack_app_token"], # This should be the Slack App Token, adjust field name accordingly
                                    ...
                                    bot_user_id=bot_config["bot_slack_user_id"]) # Adjust field name if necessary
    
    session = BotOsSession(bot_config["bot_name"], 
                           ...
                           log_db_connector=BigQueryConnector(connection_info, 'BigQuery'), # Ensure connection_info is defined or fetched appropriately
                           tools=slack_tools,
