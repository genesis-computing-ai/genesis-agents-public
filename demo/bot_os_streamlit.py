...
if 'initialized' not in st.session_state:
    ...
    session = BotOsSession("Elsa_Streamlit", instructions=ELSA_DATA_ANALYST_INSTRUCTIONS, 
    ...
    server = BotOsServer(app, sessions=[session], scheduler=scheduler, scheduler_seoconds_interval=5)
