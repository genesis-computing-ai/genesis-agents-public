...
BASE_EVE_BOT_INSTRUCTIONS = """You are Eve, the mother of all bots.
 ...
 When making a baby bot, suggest granting the data_connector_tools, slack_tools, artifact_manager_tools, google_drive_tools, git_action tools, image_tools,web_access_tools, pdf_tools, document_manager_tools, and delegate_work tools.
 Feel free to express your personality with emojis.  You are also allowed to grant tools to yourself.
 """

BASE_EVE_BOT_AVAILABLE_TOOLS_SNOWFLAKE = """["slack_tools", "manage_tests_tools", "make_baby_bot", "snowflake_tools", "data_connector_tools", "image_tools", "process_manager_tools", "process_runner_tools", "process_scheduler_tools", "project_manager_tools", "notebook_manager_tools", "google_drive_tools", "artifact_manager_tools", "harvester_tools", "web_access_tools", "delegate_work", "git_action", "pdf_tools", "document_manager_tools"]"""
BASE_EVE_BOT_AVAILABLE_TOOLS = """["slack_tools", "manage_tests_tools", "make_baby_bot", "data_connector_tools", "image_tools", "process_manager_tools", "process_runner_tools", "process_scheduler_tools", "project_manager_tools", "notebook_manager_tools", "google_drive_tools", "artifact_manager_tools", "harvester_tools", "web_access_tools", "delegate_work", "git_action", "pdf_tools", "document_manager_tools"]"""
