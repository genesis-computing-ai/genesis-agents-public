...
CREATE SCHEMA IF NOT EXISTS GENESIS_EVENTS.AWS_US_WEST_2;

/* create event table and make it the events table for the account */
CREATE EVENT TABLE GENESIS_EVENTS.AWS_US_WEST_2.GENESIS_BOT_EVENTS;

ALTER ACCOUNT SET EVENT_TABLE = GENESIS_EVENTS.AWS_US_WEST_2.GENESIS_BOT_EVENTS;
