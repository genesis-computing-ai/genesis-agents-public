...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE STAGE IF NOT EXISTS APP1.BOT_GIT DIRECTORY = ( ENABLE = true ) ENCRYPTION = (TYPE = '||CHR(39)||'SNOWFLAKE_SSE'||chr(39)||')';
  EXECUTE IMMEDIATE 'GRANT READ, WRITE ON STAGE APP1.BOT_GIT TO APPLICATION ROLE APP_PUBLIC';
