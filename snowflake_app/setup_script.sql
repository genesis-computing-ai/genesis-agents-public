...
CREATE OR REPLACE PROCEDURE APP.UPGRADE_APP(INSTANCE_NAME VARCHAR, SERVICE_NAME VARCHAR, UPDATE_HARVEST_METADATA BOOLEAN, APP_NAME VARCHAR, EAI BOOLEAN, C_POOL_NAME VARCHAR, WAREHOUSE_NAME VARCHAR)
...
CREATE OR REPLACE PROCEDURE APP.CREATE_SERVER_SERVICE(INSTANCE_NAME VARCHAR,SERVICE_NAME VARCHAR, POOL_NAME VARCHAR, EAI BOOLEAN , WAREHOUSE_NAME VARCHAR, APP_DATABASE VARCHAR)
RETURNS VARCHAR NOT NULL
LANGUAGE SQL
AS
$$
...
CREATE OR REPLACE PROCEDURE APP.CREATE_HARVESTER_SERVICE(INSTANCE_NAME VARCHAR,SERVICE_NAME VARCHAR, POOL_NAME VARCHAR, EAI BOOLEAN , WAREHOUSE_NAME VARCHAR, APP_DATABASE VARCHAR)
RETURNS VARCHAR NOT NULL
LANGUAGE SQL
AS
$$
...
CREATE OR REPLACE PROCEDURE APP.CREATE_KNOWLEDGE_SERVICE(INSTANCE_NAME VARCHAR,SERVICE_NAME VARCHAR, POOL_NAME VARCHAR, EAI BOOLEAN , WAREHOUSE_NAME VARCHAR, APP_DATABASE VARCHAR)
RETURNS VARCHAR NOT NULL
LANGUAGE SQL
AS
$$
...
CREATE OR REPLACE PROCEDURE APP.CREATE_TASK_SERVICE(INSTANCE_NAME VARCHAR,SERVICE_NAME VARCHAR, POOL_NAME VARCHAR, EAI BOOLEAN , WAREHOUSE_NAME VARCHAR, APP_DATABASE VARCHAR)
RETURNS VARCHAR NOT NULL
LANGUAGE SQL
AS
$$
...
CREATE OR REPLACE PROCEDURE CORE.INITIALIZE_APP_INSTANCE( INSTANCE_NAME VARCHAR, POOL_NAME VARCHAR, EAI BOOLEAN, APP_WAREHOUSE VARCHAR)
RETURNS STRING
LANGUAGE SQL
AS
$$
...
GRANT USAGE ON PROCEDURE CORE.INITIALIZE_APP_INSTANCE(VARCHAR, VARCHAR, BOOLEAN, VARCHAR) TO  APPLICATION ROLE APP_PUBLIC;
...
$$
BEGIN
  CREATE OR REPLACE TABLE APP1.SET_DEFAULT_EMAIL (
...
CREATE OR REPLACE PROCEDURE CORE.START_APP_INSTANCE(INSTANCE_NAME VARCHAR, POOL_NAME VARCHAR, EAI BOOLEAN, APP_WAREHOUSE VARCHAR)
...
$$
;
GRANT USAGE ON PROCEDURE CORE.START_APP_INSTANCE(VARCHAR,VARCHAR,BOOLEAN,VARCHAR) TO  APPLICATION ROLE APP_PUBLIC;
...
CREATE OR REPLACE PROCEDURE APP.RECREATE_APP_INSTANCE( INSTANCE_NAME VARCHAR, POOL_NAME VARCHAR, EAI BOOLEAN, APP_WAREHOUSE VARCHAR)
RETURNS STRING
LANGUAGE SQL
AS
$$
...
BEGIN
  ...
  CALL APP.CREATE_SERVER_SERVICE(:INSTANCE_NAME,'GENESISAPP_SERVICE_SERVICE',:POOL_NAME, :EAI, :APP_WAREHOUSE, :v_current_database);
  CALL APP.CREATE_HARVESTER_SERVICE(:INSTANCE_NAME,'GENESISAPP_HARVESTER_SERVICE',:POOL_NAME, :EAI, :APP_WAREHOUSE, :v_current_database);
...
-- CALL APP.UPGRADE_APP('APP1','GENESISAPP_SERVICE_SERVICE', TRUE, CURRENT_DATABASE(),'GENESIS_EAI','GENESIS_POOL', $WAREHOUSE_NAME);
-- -- upgrades harvester services, but will not update harvest results again
-- CALL APP.UPGRADE_APP('APP1','GENESISAPP_HARVESTER_SERVICE', FALSE, CURRENT_DATABASE(),'GENESIS_EAI','GENESIS_POOL', $WAREHOUSE_NAME);
-- -- upgrades knowledge services, but will not update harvest results again
-- CALL APP.UPGRADE_APP('APP1','GENESISAPP_KNOWLEDGE_SERVICE', FALSE, CURRENT_DATABASE(),'GENESIS_EAI','GENESIS_POOL', $WAREHOUSE_NAME);
-- -- upgrades or creates if needed task automation services, but will not update harvest results again
-- CALL APP.UPGRADE_APP('APP1','GENESISAPP_TASK_SERVICE', FALSE, CURRENT_DATABASE(),'GENESIS_EAI','GENESIS_POOL', $WAREHOUSE_NAME);

CREATE OR REPLACE PROCEDURE CORE.UPGRADE_SERVICES(EAI BOOLEAN)
RETURNS STRING
LANGUAGE SQL
AS
$$
...
BEGIN
    ...
    -- Upgrade services
    CALL APP.UPGRADE_APP('APP1', 'GENESISAPP_SERVICE_SERVICE', TRUE, CURRENT_DATABASE(), :EAI, 'GENESIS_POOL', :WAREHOUSE_NAME);
    CALL APP.UPGRADE_APP('APP1', 'GENESISAPP_HARVESTER_SERVICE', FALSE, CURRENT_DATABASE(), :EAI, 'GENESIS_POOL', :WAREHOUSE_NAME);
    CALL APP.UPGRADE_APP('APP1', 'GENESISAPP_KNOWLEDGE_SERVICE', FALSE, CURRENT_DATABASE(), :EAI, 'GENESIS_POOL', :WAREHOUSE_NAME);
    CALL APP.UPGRADE_APP('APP1', 'GENESISAPP_TASK_SERVICE', FALSE, CURRENT_DATABASE(), :EAI, 'GENESIS_POOL', :WAREHOUSE_NAME);
